...
import uk.ac.ncl.cs.group1.clientapi1.entity.AbortEntity;
import uk.ac.ncl.cs.group1.clientapi1.entity.Phase1ResponseEntity;
...
public class DocSenderImpl extends Resource implements DocSender {
    ...
    public boolean abort(UUID uuid) {
        ...
        if(!success){
            System.out.println("fail abort"+rec);
            return false;
        }
        System.out.println("success"+rec);
        return true;
    }
}
